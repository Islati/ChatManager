...
import com.caved_in.chatmanager.handlers.chat.formatting.Variables.ChatVariable;
...
public abstract class AbstractChatFormat implements IChatFormat {
	...
	public void setFormat(String Format) {
		this.Format = StringUtils.replaceOnce(StringUtils.replaceOnce(Format, SenderVariable.getChatVariable(), SenderVariable.getVariableReplace()),
				MessageVariable.getChatVariable(), MessageVariable.getVariableReplace());
	}
}
